...
namespace Invio.Immutable {
    ...
    ///   <see cref="Double" />.
    /// </summary>
    public sealed class DoublePropertyHandler : PropertyHandlerBase<Double> {
        /// <summary>
        ...
        /// <summary>
        ///   Create a new instance of <see cref="DoublePropertyHandler" /> with the specified
        ///   precision settings.
        /// </summary>
        /// <param name="property">
        ///   A <see cref="PropertyInfo" /> for a property that is of type <see cref="Double" />.
        /// </param>
        ...
        protected override Boolean ArePropertyValuesEqualImpl(
            Double leftPropertyValue,
            Double rightPropertyValue) {
        ...
        /// </summary>
        /// <inheritdoc />
        protected override Int32 GetPropertyValueHashCodeImpl(Double propertyValue) {
        ...
        private static Double RoundToSignificantDigits(Double value, Int32 precision){
            var scale = Math.Pow(10, Math.Floor(Math.Log10(Math.Abs(value))) + 1);
            return scale * Math.Round(value / scale, precision);
        }
    }
}